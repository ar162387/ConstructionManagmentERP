  ...
  const userSpecs = [
    {
      ...
      assignedProjectIds: undefined as string[] | undefined,
      assignedProjectNames: undefined as string[] | undefined,
    },
    {
      name: "Company Admin",
      email: "admin@erp.com",
    ...
    },
    {
      ...
      assignedProjectIds: siteProjectId ? [siteProjectId] : undefined,
      assignedProjectNames: siteProjectName ? [siteProjectName] : undefined,
    },
  ];
    ...
    await User.updateOne(
      { email: user.email },
      {
        $set: {
          ...
          assignedProjectNames: user.assignedProjectNames,
        },
      },
      { upsert: true }
    );
